export default {
  methods: {
    getColorXy: function(rgbhex) {
      let rgb = ColorConverter.hexToRGB(rgbhex)
      return ColorConverter.rgbToXy(rgb.r, rgb.g, rgb.b)
    },
    getColorRgb: function(xy, bri) {
      let rgb = ColorConverter.xyBriToRgb(xy.x, xy.y, bri)
